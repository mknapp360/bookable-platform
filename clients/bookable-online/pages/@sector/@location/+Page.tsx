    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-100 bg-white sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <a
            ...
            className="bg-bookable-green text-white text-sm font-semibold px-5 py-2 rounded-full hover:bg-green-700 transition-colors"
          >
            Get started
          </a>
        </div>
      ...
      <section className="pt-20 pb-16 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <p className="text-sm font-semibold text-bookable-green uppercase tracking-widest mb-3">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="/"
              className="inline-flex items-center justify-center gap-2 bg-bookable-green text-white px-8 py-3.5 rounded-full font-semibold hover:bg-green-700 transition-colors"
            >
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div>
            <a
              href="/"
              className="inline-flex items-center gap-2 bg-bookable-green text-white px-10 py-4 rounded-full font-semibold text-lg hover:bg-green-700 transition-colors"
            >
