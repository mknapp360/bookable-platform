...
export default function Head() {
    ...
    '@graph': [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: sector.namePlural, item: `https://www.bookable.online/${sector.slug}` },
          { '@type': 'ListItem', position: 3, name: location.name, item: `https://www.bookable.online/${sector.slug}/${location.slug}` },
        ],
      },
      {
        '@type': 'FAQPage',
  ...
  return (
    <>
      ...
      <link rel="canonical" href={`https://www.bookable.online/${sector.slug}/${location.slug}`} />
      <meta property="og:title" content={title} />
      <meta property="og:description" content={description} />
      <meta property="og:type" content="website" />
      <meta property="og:url" content={`https://www.bookable.online/${sector.slug}/${location.slug}`} />
