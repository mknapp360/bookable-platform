import { Users, CalendarCheck, CreditCard, FileText, MessageSquare } from 'lucide-react'
...
export default function WhatWeBuild() {
  return (
    <section id="what-is-bookable-crm" className="py-20 bg-white" aria-label="What is Bookable CRM">
      <div className="max-w-6xl mx-auto px-6">

        {/* Header */}
        <div className="text-center mb-14">
          <p className="text-sm font-semibold text-bookable-green uppercase tracking-widest mb-4">What is Bookable CRM</p>
          ...
          <p className="mt-5 text-lg text-gray-600 max-w-2xl mx-auto">
            Build your business workflow from lead to completion, that runs automatically.
          </p>
        </div>
