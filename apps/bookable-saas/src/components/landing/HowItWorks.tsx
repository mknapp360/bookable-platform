    ...
    <section id="how-it-works" className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-14">
          <p className="text-sm font-semibold text-bookable-green uppercase tracking-widest mb-4">How it works</p>
              ...
              <div key={step.number} className="relative">
                ...
                {i < steps.length - 1 && (
                  <div className="hidden lg:flex absolute top-10 -right-3 z-10 items-center justify-center">
                    <ArrowRight size={20} className="text-bookable-green" />
                  </div>
                )}
                <div className="flex flex-col items-center h-full">
                  ...
                  <div className="relative">
                    <div className="w-20 h-20 rounded-full bg-green-50 flex items-center justify-center">
                      <Icon size={34} className="text-bookable-green opacity-70" />
                    </div>
                    <span className="absolute -bottom-3.5 left-1/2 -translate-x-1/2 w-7 h-7 rounded-full bg-bookable-green text-white text-xs font-bold flex items-center justify-center">
                      {step.number}
                    </span>
                  </div>
                  {/* Card */}
                  <div className="bg-white rounded-2xl mt-3.5 px-6 py-6 border border-gray-100 shadow-sm w-full flex-1">
                    ...
                    <div className="w-8 h-0.5 bg-bookable-green mb-3 rounded-full mx-auto" />
          ...
          <div className="flex items-start gap-4 flex-1">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-0.5">
                Most systems are <span className="text-bookable-green font-semibold">live within a few weeks.</span>
              </p>
            </div>
          </div>
          <div className="flex flex-wrap gap-x-8 gap-y-2">
            {trustItems.map((item) => (
              <span key={item} className="flex items-start gap-1.5 text-sm text-gray-600 whitespace-pre-line">
                <span className="text-bookable-green font-bold mt-0.5">✓</span>
                {item}
              </span>
            ))}
          </div>
        ...
        <div className="text-center">
          <a
            href="/signup"
            className="inline-flex items-center gap-2 bg-bookable-green text-white px-8 py-4 rounded-full font-semibold text-base hover:bg-green-700 transition-colors"
          >
